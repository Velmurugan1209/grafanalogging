...
const INPUT_DIR = path.join(ROOT_DIR, "src", "uat", "shionogi");
const OUTPUT_DIR = path.join(ROOT_DIR, "src", "uat", "shionogi", "output");
...
if (files.length === 0) {
  console.error("No input files found in uat/shionogi");
  process.exit(1);
}
